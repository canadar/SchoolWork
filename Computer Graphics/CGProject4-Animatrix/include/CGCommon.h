...
// Needed throughout a graphics program
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <math.h>
...
// Microsoft's compiler needs a custom file here and to turn off the MIN MAX macros
#ifdef _MSC_VER
    #define NOMINMAX
...
// This must happen before glu on windows
#ifdef WIN32
    #include <windows.h>
#endif
...
// Easy way to change between floats and doubles
#define CG_REAL double

// Easy macro for checking the OpenGL error state (and possibly aborting when one had occured)

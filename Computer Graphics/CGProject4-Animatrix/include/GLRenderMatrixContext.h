...
protected:
    ...
    // Stacks used to save and restore transformations
    QStack<QMatrix4x4> mProjMatrixStack;
    QStack<QMatrix4x4> mModelMatrixStack;
    QStack<QMatrix4x4> mViewMatrixStack;

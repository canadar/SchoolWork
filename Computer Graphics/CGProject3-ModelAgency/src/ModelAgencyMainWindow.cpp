...
void ModelAgencyMainWindow::syncTransformation()
{
    ...
    lCurObj->setRotate(ui->rotationAngleSpinBox->value(),
                       ui->rotaiotnXSpinBox->value(), ui->rotaitonYSpinBox->value(), ui->rotaitonZSpinBox->value());
...
inline void ModelAgencyMainWindow::clearObjectUIData()
{
    ...
    ui->rotationAngleSpinBox->setValue(0);
...
inline void ModelAgencyMainWindow::setTransformationValues(ObjectNode *pCurObj)
{
    ...
    CG_REAL lRx, lRy, lRz, lAngle;
    pCurObj->getRotation(lAngle, lRx, lRy, lRz);
    ui->rotaiotnXSpinBox->setValue(lRx);
    ui->rotaitonYSpinBox->setValue(lRy);
    ui->rotaitonZSpinBox->setValue(lRz);
    ui->rotationAngleSpinBox->setValue(lAngle);
